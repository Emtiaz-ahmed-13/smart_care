...
class Doctor(models.Model):
    ...
    def __str__(self):
        first_name = self.user.first_name or "No First Name"
        last_name = self.user.last_name or "No Last Name"
...
class Review(models.Model):
    ...
    rating = models.CharField(max_length=10, choices=STAR_CHOICES)  # Added max_length
